...
public class ConvertKit {
     ...
     * @param unit       单位类型
     *                   <ul>
     *                   <li>{@link MemoryConst#BYTE}: 字节</li>
     *                   <li>{@link MemoryConst#KB}  : 千字节</li>
     *                   <li>{@link MemoryConst#MB}  : 兆</li>
     *                   <li>{@link MemoryConst#GB}  : GB</li>
     *                   </ul>
     * @return 字节数
     */
    ...
    public static ByteArrayOutputStream input2OutputStream(final InputStream is) {
        ...
        try {
            ...
            byte[]                b  = new byte[MemoryConst.KB];
            int                   len;
            while ((len = is.read(b, 0, MemoryConst.KB)) != -1) {
                os.write(b, 0, len);
            }
            return os;
        } catch (IOException e) {
