...
import cn.br.common.job.CronExpression;
...
public class Time {
	...
	/**
	 * Compute the number of milliseconds between the next valid date and the one
	 * after
	 *
	 * @param cron The CRON String
	 * @return the number of milliseconds between the next valid date and the one
	 *         after, with an invalid interval between
	 */
